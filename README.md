...
<p align="center">
  <img src="docs/app-icon.svg" width="128" alt="MouseDance 图标">
</p>

一款常驻菜单栏的 macOS 小工具：为多显示器用户的每一块屏幕配置独立快捷键，按下快捷键即可让鼠标瞬间"跳舞"到目标屏幕中央。

界面全面采用 macOS Tahoe 液态玻璃（Liquid Glass）设计，图标经 Icon Composer 分层打造，随系统外观呈现玻璃立体质感。

## 功能特性

- **多屏快捷键跳转**：为每一块屏幕单独录制快捷键，按下后鼠标立即跳转到对应屏幕
- **快捷切换**：一个全局快捷键，在当前屏幕与上一个活跃屏幕之间来回切换鼠标
- **指针跟随激活 App**：开启后，当焦点切换到另一块屏幕上的 App 时，鼠标自动跳转到该 App 窗口，无需横跨桌面寻找指针；同屏切换不打扰
...
- **液态玻璃界面**：设置窗口、快捷键录制器与菜单均遵循 macOS Tahoe 设计规范，支持深浅色外观与"降低透明度"辅助功能降级
...
4. **开启"指针跟随激活 App"（可选）**
   在"全局配置"中打开该开关后，当焦点切换到另一块屏幕上的 App 时，鼠标会自动跳转到该 App 窗口；同一屏幕内切换不会移动鼠标。
